...
import com.luxoft.training.java2.module7.ExampleClass.MyAnnotation;
...
public class ReflectionTutor {
	...
	public void testShowConstractors() {
		showConstructors(java.io.PrintStream.class);
	...
	public void testInvoke() {
		...
		try {
			...
			Class<?> cls = Class.forName("com.luxoft.training.java2.module7.ExampleClass");
			...
			MyAnnotation annotation = method.getAnnotation(ExampleClass.MyAnnotation.class);
